...
namespace FetaProject.iOS
{
    public partial class DisplayMapView : UIViewController
    {
		...
		public void OnMapReady()
		{
			...
			var a = 0; // artosc testowa usunąć w przypadku podmienienia na UISegmentView.Value
			...
			{
				//CZWARTEK  
				doc.Load("https://www.google.com/maps/d/kml?mid=1YAdsxSz644qe4F90BerIaSeENgk&forcekml=1");
			}
			else if (a == 1)
			{
				//PIATEK
				doc.Load("https://www.google.com/maps/d/kml?mid=1U_fAWaQwaIVGbZ1lk-TC9Bxn7n0&forcekml=1");
			}
			else if (a == 3)
			{
				//NIEDZIELA
